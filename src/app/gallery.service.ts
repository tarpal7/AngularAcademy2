...
itemsStart = [
  ...
  //
  //   //  console.log(GalleryService.getFromLS(GalleryService.keyStorage));
  //   console.log(GalleryService.getFromLS(this.keyStorage))
  //   if (GalleryService.getFromLS(this.keyStorage)) {
  //     GalleryService.items = GalleryService.getFromLS(this.keyStorage);
  //   } else {
  //     GalleryService.items = GalleryService.itemsStart;
  //     GalleryService.saveInLocalSorage(GalleryService.items, this.keyStorage);
  //   }
  // }
